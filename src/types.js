...
export const TOGGLE_CREDENTIALS = 'TOGGLE_CREDENTIALS';
...
export const ADD_UPDATE_CREDENTIALS = 'ADD_CREDENTIALS';
export const REMOVE_CREDENTIALS = 'REMOVE_CREDENTIALS';
export const UPDATE_WAVV_CONNECTION = 'UPDATE_WAVV_CONNECTION';
